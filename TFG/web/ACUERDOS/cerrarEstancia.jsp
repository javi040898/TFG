<%-- 
    Document   : cerrarEstancia
    Created on : 08-jun-2021, 13:43:40
    Author     : Javier
--%>
...
<html>
    ...
    <body>
        ...
        <form action="ProfesorController?accion=listarAlumnosCerrar" method="POST" autocomplete="off">
            <p align="center"> 
            <div id="form6">

                <h1>NUEVA CIERRE DE ESTANCIA</h1>

                <select class="form-control" id="listaEstanciasAlumnosCerrar" name="listaEstanciasAlumnosCerrar">
