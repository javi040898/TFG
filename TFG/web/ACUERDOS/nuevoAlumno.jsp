...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">   <title>NUEVA ALUMNO</title>
    ...
    <body>
        ...
        <form action="PropuestaLA?accion=insertarAlumno" method="POST" autocomplete="off">
            <div id="form10">
                <h1>NUEVO ALUMNO</h1>
